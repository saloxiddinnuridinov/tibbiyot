...
use App\Http\Resources\ObjectFileResource;
...
class ObjectFileController extends Controller
{
     ...
     *          @OA\JsonContent(ref="#/components/schemas/ObjectFile"),
     *       ),
     *      @OA\Response(
     *          response=401,
    ...
    {
        return ObjectFileResource::collection(ObjectFile::all());
    }
