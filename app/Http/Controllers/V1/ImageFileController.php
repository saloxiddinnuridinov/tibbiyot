...
class ImageFileController extends Controller
{
     ...
     *         @OA\JsonContent(ref="#/components/schemas/ImageFile"),
     *       ),
     *      @OA\Response(
     *          response=401,
    ...
    {
        return ImageFileResource::collection(ImageFile::all());
    }
 ...
 *          @OA\JsonContent(ref="#/components/schemas/ImageFile"),
    ...
    {
        return new ImageFileResource(ImageFile::find($id));
    }
