...
use App\Http\Resources\LessonJoinVideoFileResource;
...
class LessonJoinVideoFileController extends Controller
{
     ...
     *         @OA\JsonContent(ref="#/components/schemas/LessonJoinVideoFile"),
     *       ),
     *      @OA\Response(
     *          response=401,
    ...
    {
        return LessonJoinVideoFileResource::collection(LessonJoinVideoFile::all());
    }
 ...
 *           @OA\JsonContent(ref="#/components/schemas/LessonJoinVideoFile"),
    ...
    {
        return new LessonJoinVideoFileResource(LessonJoinVideo::find($id));
    }
    ...
    *               @OA\Property(property="video_file_id", type="integer", format="number", example="2")
    ...
    {
        $model = LessonJoinVideoFile::find($id);
        if($model){
            try {
                $model->delete();
